  ...
  <div id="about" class="min-h-screen scroll-mt-20 bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      <div class="flex flex-col lg:flex-row gap-12 mb-20">
        ...
        <div class="lg:w-1/2 order-2 flex flex-col justify-center">
          <h2 class="text-4xl font-bold text-amber-900 mb-6">About Us</h2>
          <p class="text-lg text-gray-600 mb-4">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat
            dolores suscipit sit ad nisi aspernatur laudantium perferendis eos
            necessitatibus, hic repellat atque totam ipsum. Explicabo
            similique repellat eligendi nam sed.
          </p>
          <div class="grid grid-cols-2 gap-4 mt-4">
            <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
              <h4 class="font-semibold text-pink-600">500+</h4>
              <p class="text-gray-600">Unique fragrance</p>
            </div>
            <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
...
<script setup>
import prod from "../assets/Womens/product19.jpg";
</script>